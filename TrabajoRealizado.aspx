		...
		<form id="Form1" method="post" runat="server" bgcolor="#ffffff">
            <asp:Panel ID="Panel3" runat="server" Font-Size="Small">
				<asp:label id="Label1" style="Z-INDEX: 100; LEFT: 24px; POSITION: absolute; TOP: 16px" runat="server"
					Font-Bold="False" Height="24px" Width="488px" Text="Totales de Expedientes con Fecha de Creación entre" />
				...
				<asp:panel id="Panel2" style="overflow:auto; POSITION: absolute; TOP: 352px"
					runat="server" Height="144px" Width="800px" BorderStyle="Ridge">
					<asp:datagrid id="Datagrid2" runat="server" Height="192px" Width="780px" BorderStyle="Ridge" BorderColor="Black"
						BorderWidth="1px" AllowSorting="false" AutoGenerateColumns="False">
						...
						<Columns>
							...
							<asp:BoundColumn DataField="ExpEditados" HeaderText="Tot. Exp. Editados entre fechas">
								<HeaderStyle Width="15%"></HeaderStyle>
								<ItemStyle Wrap="False"></ItemStyle>
							</asp:BoundColumn>
						</Columns>
				...
				<asp:panel id="Panel1" style="Z-INDEX: 101; LEFT: 16px; OVERFLOW: auto; POSITION: absolute; TOP: 144px"
					runat="server" Height="152px" Width="800px" BorderStyle="Ridge">
					<asp:datagrid id="DataGrid1" runat="server" Height="176px" Width="780px" BorderStyle="Ridge" BorderColor="Black"
						BorderWidth="1px" AllowSorting="false" AutoGenerateColumns="False">
						<AlternatingItemStyle Wrap="False" BackColor="#E0E0E0"></AlternatingItemStyle>
						<ItemStyle Wrap="False"></ItemStyle>
						<HeaderStyle Font-Underline="True" Font-Bold="True"></HeaderStyle>
						<Columns>
							...
							<asp:BoundColumn DataField="EntreFechas" HeaderText="Tot. entre fechas">
								<HeaderStyle Width="15%"></HeaderStyle>
								<ItemStyle Wrap="False"></ItemStyle>
							</asp:BoundColumn>
						</Columns>
					</asp:datagrid>
					<asp:Label id="noHayDatosLabel" runat="server" Font-Bold="True" Visible="False" Text="No hay datos que mostrar"/>
				</asp:panel>
			</asp:Panel>
		</form>
	</body>
