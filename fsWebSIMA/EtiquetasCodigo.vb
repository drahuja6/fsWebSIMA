...
Public Class EtiquetasCodigo
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "fsWebSIMA.EtiquetasCodigo.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedEtiquetasCodigo
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As EtiquetasCodigo = New EtiquetasCodigo()
        rpt.Site = Me.Site
        Return rpt
    End Function
