...
Public Class ListaDeExpedientes
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "fsWebS_SEN.ListaDeExpedientes.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedListaDeExpedientes
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ListaDeExpedientes = New ListaDeExpedientes()
        rpt.Site = Me.Site
        Return rpt
    End Function
