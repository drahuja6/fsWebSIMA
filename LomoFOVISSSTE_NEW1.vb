...
Public Class LomoFOVISSSTE_NEW
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "fsWebS_SEN.LomoFOVISSSTE_NEW.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedLomoFOVISSSTE_NEW
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As LomoFOVISSSTE_NEW = New LomoFOVISSSTE_NEW()
        rpt.Site = Me.Site
        Return rpt
    End Function
