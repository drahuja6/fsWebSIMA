...
#End Region
    ...
    Private Sub btnBuscaLotes_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnBuscaLotes.Click
        ...
        FillDropDownList2(Session("UsuarioVirtualConnString"), ddlBatches, "LotesPorAtender", ddlUnidAdm.SelectedValue, 2, "idBatch", "Descripcion", -1)
    ...
    Private Sub btnBuscaLote_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnBuscaLote.Click
        ...
        FillListBoxSpecial_1(lbExpDelLote, Session("UsuarioVirtualConnString"), "SelExpDeLoteBAJA", ddlBatches.SelectedValue, "Expediente", "idExpediente")

        FillListBoxSpecial_1(lbExpConCajaConc, Session("UsuarioVirtualConnString"), "SelExpDeLote2BAJA", ddlBatches.SelectedValue, "Expediente", "idExpediente")
    ...
    Private Sub btnAsignaCajaConc_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnAsignaCajaConc.Click
        ...
        For Each item In lbExpDelLote.Items
            If item.Selected Then
                ...
                Batches_Relaciones_UPDATE_CAJAPROV2(ddlBatches.SelectedValue, item.Value, "99999") ' txtCajaConc.Text)
    ...
    Private Sub btnImprimeResguardo_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnImprimeResguardo.Click
        ...
        Exp_UPD_Stat_Baja(ddlBatches.SelectedValue)
    ...
    Sub ImprimeLoteConcTerminado(ByVal idBatch As Integer)
        ...
        Try
            ...
            Response.AddHeader("content-Disposition", "inline; filename=recepcionbaja.pdf")
    ...
    Public Function Exp_UPD_Stat_Baja(ByVal idBatch As Integer) As Integer
        ...
        Try
            ...
            'Asigno el Stored Procedure
            cmd.CommandText = "Exp_UPD_Stat_Baja"
            cmd.Connection = cn
            cmd.CommandType = Data.CommandType.StoredProcedure
            ...
            'Leo el id del record editado
            Exp_UPD_Stat_Baja = CInt(cmd.Parameters("idBatchEditado").Value)
    ...
    Private Sub btnFinalizarLote_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnFinalizarLote.Click
        ...
        'tienen estatus 7 (Baja)

        If AllExpDeLoteEnStatusX(ddlBatches.SelectedValue, 7) Then
