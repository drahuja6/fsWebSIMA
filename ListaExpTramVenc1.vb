...
Public Class ListaExpTramVenc
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "fsWebS_SEN.ListaExpTramVenc.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_UnidadAdministrativa() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedListaExpTramVenc
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ListaExpTramVenc = New ListaExpTramVenc()
        rpt.Site = Me.Site
        Return rpt
    End Function
