...
Public Class AuditoriaPorUA
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "fsWebS_SEN.AuditoriaPorUA.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedAuditoriaPorUA
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As AuditoriaPorUA = New AuditoriaPorUA()
        rpt.Site = Me.Site
        Return rpt
    End Function
