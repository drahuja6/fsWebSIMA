...
#End Region
    ...
    Private Sub btnBuscaVencidos_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnBuscaVencidos.Click
        ...
        FillListBoxSpecial(lbExpVencEnTramite, Session("UsuarioVirtualConnString"), "SelVencEnTramite", ddlUnidAdm.SelectedValue, CDate(txtFechaDeCorte.Text), "Expediente", "idExpediente")
    ...
    Private Sub btnNuevoBatch_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnNuevoBatch.Click
        ...
        If lbExpVencEnTramite.Items.Count = 0 Then
        ...
        idNuevoBatch = Batches_INSERT(txtNuevoBatchDesc.Text, Session("idUsuarioReal"), CDate(Format(Now(), "dd/MM/yyyy")), 1, ddlUnidAdm.SelectedValue, CDate(txtFechaDeCorte.Text))
        ...
        Try
            Do
                ...
                For Each item In lbExpConCaja.Items
                    If item.Selected Then
                        Batches_Relaciones_DELETE(txtNuevoBatchID.Text, item.Value, 2)
    ...
    Private Sub btnImprimeEnvio_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnImprimeEnvio.Click
        ...
        Try
            ...
            Response.AddHeader("content-Disposition", "inline; filename=enviadosconcentracion.pdf")
    ...
    Private Sub btnImpListado_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnImpListado.Click
        ...
        Try
            ...
            cmd.Connection = cn
            cmd.Parameters.Clear()
            cmd.CommandText = "SelVencEnTramite"
            cmd.CommandTimeout = 0
            ...
            'Write the file directly to the HTTP output stream.
            Response.ContentType = "application/pdf"
            Response.AddHeader("content-Disposition", "inline; filename=listadovencidostramite.pdf")
            Response.WriteFile(MyFileName)
            Response.Flush()
