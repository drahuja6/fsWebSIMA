	...
	<body bgColor="#ffffff" style="font:x-small">
		<form id="Form1" method="post" runat="server"  style="font:x-small">
			...
			<asp:label id="Label1" style="Z-INDEX: 100; LEFT: 8px; POSITION: absolute; TOP: 8px" runat="server"
				Width="56px" Font-Bold="True" Height="16px">Código</asp:label>
			<asp:textbox id="txtCodigo" style="Z-INDEX: 101; LEFT: 64px; POSITION: absolute; TOP: 8px" tabIndex="1"
				runat="server" Text="" Width="112px" Height="20px" Enabled="False" Font-Size="XX-Small"></asp:textbox><asp:label id="Label2" style="Z-INDEX: 102; LEFT: 248px; POSITION: absolute; TOP: 8px" runat="server"
				Width="136px" Font-Bold="True" Height="16px">Jerarquía superior:</asp:label>
			<asp:label id="Label3" style="Z-INDEX: 103; LEFT: 8px; POSITION: absolute; TOP: 32px" runat="server"
				Width="80px" Font-Bold="True" Height="16px">Expediente</asp:label>
			...
			<asp:label id="Label4" style="Z-INDEX: 106; LEFT: 8px; POSITION: absolute; TOP: 56px" runat="server"
				Width="32px" Font-Bold="True" Height="16px">Ref</asp:label><asp:textbox id="txtTipo" style="Z-INDEX: 107; LEFT: 40px; POSITION: absolute; TOP: 56px" tabIndex="3"
				runat="server" Text="" Width="40px" Height="20px" Enabled="False" Font-Size="XX-Small"></asp:textbox>
			<asp:label id="Label5" style="Z-INDEX: 108; LEFT: 96px; POSITION: absolute; TOP: 56px" runat="server"
				Width="32px" Font-Bold="True" Height="16px">Más</asp:label>
			...
			<asp:label id="Label6" style="Z-INDEX: 110; LEFT: 8px; POSITION: absolute; TOP: 96px" runat="server"
				Width="56px" Font-Bold="True" Height="16px">Nombre</asp:label>
			<asp:textbox id="txtNombre" style="Z-INDEX: 111; LEFT: 64px; POSITION: absolute; TOP: 88px" tabIndex="6"
				runat="server" Text="" Width="640px" Height="38px" Enabled="False" TextMode="MultiLine" Font-Size="XX-Small"></asp:textbox><asp:label id="Label7" style="Z-INDEX: 112; LEFT: 544px; POSITION: absolute; TOP: 128px" runat="server"
				Width="88px" Font-Bold="True" Height="16px">No. de fojas</asp:label>
			<asp:textbox id="txtNoDeFojas" style="Z-INDEX: 113; LEFT: 632px; POSITION: absolute; TOP: 128px"
				tabIndex="5" runat="server" Text="" Width="56px" Height="20px" Enabled="False" Font-Size="XX-Small"></asp:textbox><asp:label id="Label8" style="Z-INDEX: 114; LEFT: 8px; POSITION: absolute; TOP: 128px" runat="server"
				Width="160px" Font-Bold="True" Height="16px">Apertura (dd/mm/aaaa)</asp:label>
			...
			<asp:label id="Label9" style="Z-INDEX: 116; LEFT: 280px; POSITION: absolute; TOP: 128px" runat="server"
				Width="144px" Font-Bold="True" Height="16px">Cierre (dd/mm/aaaa)</asp:label>
			...
			<asp:label id="Label10" style="Z-INDEX: 118; LEFT: 8px; POSITION: absolute; TOP: 152px" runat="server"
				Visible="False" Text="Pase a Baja/Histórico (dd/mm/aaaa)" Width="240px" Font-Bold="True">Pase a Baja/Histórico (dd/mm/aaaa)</asp:label>
			<asp:label id="Label11" style="Z-INDEX: 119; LEFT: 360px; POSITION: absolute; TOP: 152px" runat="server"
				Visible="False" Text="Autoriza" Width="64px" Font-Bold="True">Autoriza</asp:label>
			...
			<asp:panel id="PLocalizacion" style="Z-INDEX: 129; LEFT: 8px; POSITION: absolute; TOP: 224px"
				...
				<asp:Label id="Label44" style="Z-INDEX: 159; LEFT: 8px; POSITION: absolute; TOP: 0px" runat="server"
					Width="128px" BackColor="PaleTurquoise" Height="12px" Font-Bold="True" Font-Size="XX-Small">Archivo Trámite</asp:Label>
				<asp:Label id="Label14" style="Z-INDEX: 102; LEFT: 8px; POSITION: absolute; TOP: 23px" runat="server"
					Width="64px" Height="16px" Font-Bold="True" Font-Size="XX-Small">Caja No.</asp:Label>
				<asp:Label id="Label15" style="Z-INDEX: 105; LEFT: 8px; POSITION: absolute; TOP: 47px" runat="server"
					Width="64px" Height="16px" Font-Bold="True" Font-Size="XX-Small">Anaquel</asp:Label>
				<asp:Label id="Label16" style="Z-INDEX: 108; LEFT: 8px; POSITION: absolute; TOP: 71px" runat="server"
					Width="64px" Height="16px" Font-Bold="True" Font-Size="XX-Small">Ubicación </asp:Label>
				<asp:Label id="Label17" style="Z-INDEX: 109; LEFT: 8px; POSITION: absolute; TOP: 95px" runat="server"
					Width="64px" Height="16px" Font-Bold="True" Font-Size="XX-Small">Observaciones</asp:Label>
				...
				<asp:Label id="Label18" style="Z-INDEX: 112; LEFT: 8px; POSITION: absolute; TOP: 115px" runat="server"
					Width="144px" Height="16px" Font-Bold="True" Font-Size="XX-Small">Archivo Concentración</asp:Label>
				...
				<asp:Label id="Label22" style="Z-INDEX: 144; LEFT: 160px; POSITION: absolute; TOP: 8px" runat="server"
					Width="104px" Height="16px" Font-Bold="True">Movimientos</asp:Label>
			</asp:panel>&nbsp;&nbsp;&nbsp;
			<asp:label id="Label23" style="Z-INDEX: 130; LEFT: 16px; POSITION: absolute; TOP: 440px" runat="server"
				Width="160px" Font-Bold="True" Height="16px">Creación (dd/mm/aaaa)</asp:label>
			...
			<asp:label id="Label24" style="Z-INDEX: 132; LEFT: 280px; POSITION: absolute; TOP: 440px" runat="server"
				Width="72px" Font-Bold="True" Height="16px">Elaborado</asp:label>&nbsp;
			<asp:label id="Label25" style="Z-INDEX: 133; LEFT: 488px; POSITION: absolute; TOP: 440px" runat="server"
				Width="96px" Font-Bold="True" Height="16px">Ultima edición</asp:label>&nbsp;
			...
			<asp:panel id="PClasificacion" style="Z-INDEX: 153; LEFT: 8px; POSITION: absolute; TOP: 224px"
				runat="server" Visible="False" Width="632px" BackColor="#FFE0C0" Height="216px" BorderStyle="None">
			...
			<asp:Label id="Label28" style="Z-INDEX: 120; LEFT: 8px; POSITION: absolute; TOP: 56px" runat="server"
								Width="208px" Height="16px" Font-Bold="True">Clasificación (dd/mm/aaaa)</asp:Label>
			...
			<asp:Label id="Label29" style="Z-INDEX: 127; LEFT: 8px; POSITION: absolute; TOP: 80px" runat="server"
								Width="208px" Height="16px" Font-Bold="True">Prop. Desclasif. (dd/mm/aaaa)</asp:Label>
			...
			<asp:Label id="Label30" style="Z-INDEX: 136; LEFT: 8px; POSITION: absolute; TOP: 112px" runat="server"
								Width="264px" Height="16px" Font-Bold="True">Fundamentos legales de la clasificación</asp:Label>&nbsp; 
			...
			<asp:Label id="Label31" style="Z-INDEX: 144; LEFT: 320px; POSITION: absolute; TOP: 8px" runat="server"
								Width="248px" Height="16px" Font-Bold="True">Ampliación del plazo de clasificación</asp:Label>
			<asp:Label id="Label32" style="Z-INDEX: 150; LEFT: 320px; POSITION: absolute; TOP: 32px" runat="server"
								Width="208px" Height="16px" Font-Bold="True">Nueva desclasif. (dd/mm/aaaa)</asp:Label>&nbsp; 
			...
			<asp:Label id="Label34" style="Z-INDEX: 161; LEFT: 320px; POSITION: absolute; TOP: 80px" runat="server"
								Width="64px" Height="16px" Font-Bold="True">Autoriza</asp:Label>&nbsp; 
			<asp:Label id="Label35" style="Z-INDEX: 163; LEFT: 320px; POSITION: absolute; TOP: 144px" runat="server"
								Width="208px" Height="16px" Font-Bold="True">Fecha Desclasif. (dd/mm/aaaa)</asp:Label>
			...
			<asp:CheckBox id="chkbxNuevaParteDelDocumento" style="Z-INDEX: 173; LEFT: 320px; POSITION: absolute; TOP: 56px"
								tabIndex="28" runat="server" Text="Parte del documento" Font-Bold="True" Enabled="False"
								Checked="False"></asp:CheckBox>
			...
			<asp:panel id="PAtributos" style="Z-INDEX: 154; LEFT: 8px; POSITION: absolute; TOP: 224px"
				runat="server" Visible="False" Width="632px" Height="216px" BorderStyle="None">
				<asp:Label id="Label37" style="Z-INDEX: 100; LEFT: 8px; POSITION: absolute; TOP: 8px" runat="server"
					Width="120px" Height="16px" Font-Bold="True">Valor documental</asp:Label>
				...
				<asp:Label id="Label38" style="Z-INDEX: 107; LEFT: 144px; POSITION: absolute; TOP: 8px" runat="server"
					Width="168px" Height="16px" Font-Bold="True">Plazos de conservación</asp:Label>
				<asp:Label id="Label39" style="Z-INDEX: 113; LEFT: 144px; POSITION: absolute; TOP: 40px" runat="server"
					Width="56px" Height="16px" Font-Bold="True">Trámite</asp:Label>
				<asp:Label id="Label40" style="Z-INDEX: 118; LEFT: 144px; POSITION: absolute; TOP: 64px" runat="server"
					Width="104px" Height="16px" Font-Bold="True">Concentración</asp:Label>
				...
				<asp:Label id="Label41" style="Z-INDEX: 129; LEFT: 376px; POSITION: absolute; TOP: 8px" runat="server"
					Width="96px" Height="16px" Font-Bold="True">Destino final</asp:Label>
				...
				<asp:Label id="Label43" style="Z-INDEX: 139; LEFT: 376px; POSITION: absolute; TOP: 64px" runat="server"
					Width="248px" Height="16px" Font-Bold="True">Fundamentos legales de destino final</asp:Label>
			...
			<asp:panel id="PPDFs" style="Z-INDEX: 155; LEFT: 8px; OVERFLOW: auto; POSITION: absolute; TOP: 224px"
				runat="server" Visible="False" Width="632px" Height="216px">
				<P>
				...
				<P>
					<asp:Label id="NoHayDatos2" runat="server" Visible="False" Width="192px" Font-Bold="True">No hay datos que mostrar</asp:Label>
				</P>
				<P>&nbsp;</P>
			</asp:panel>
