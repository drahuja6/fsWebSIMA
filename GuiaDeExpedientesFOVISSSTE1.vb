...
Public Class GuiaDeExpedientesFOVISSSTE
    ...
    Public Overrides Property ResourceName As String
        Get
            Return "GuiaDeExpedientesFOVISSSTE.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedGuiaDeExpedientesFOVISSSTE
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As GuiaDeExpedientesFOVISSSTE = New GuiaDeExpedientesFOVISSSTE
        rpt.Site = Me.Site
        Return rpt
    End Function
