	...
	<body bgColor="#ffffff">
		<form id="Form1" method="post" runat="server">
			...
			<asp:Button id="Button1" style="Z-INDEX: 107; LEFT: 528px; POSITION: absolute; TOP: 8px" runat="server"
				Text="Ver ventana de edición de usuarios" ToolTip="Permite ver directamente la ventana de edición de usuarios, en caso de que no necesite hacer una búsqueda (por ejemplo, si quiere comenzar a añadir directamente)"></asp:Button></form>
	</body>
</HTML>
