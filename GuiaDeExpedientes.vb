...
Public Class GuiaDeExpedientes
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "fsWebS_SEN.GuiaDeExpedientes.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedGuiaDeExpedientes
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As GuiaDeExpedientes = New GuiaDeExpedientes()
        rpt.Site = Me.Site
        Return rpt
    End Function
